...
*/
       ...
       <vaadin-number-field placeholder="最低" value="{{min}}"> </vaadin-number-field><span>至 </span>  <vaadin-number-field placeholder="最高" value="{{max}}"></vaadin-number-field>
    </div> 
    <p>
        <input type="text" id="amount" value="{{amount}}" readonly style="border:0; color:#f6931f; font-weight:bold;">
        
    </p>
    <div id="price_panel">
        <div></div>
        <vaadin-button on-click="_reset">重設</vaadin-button>
        <vaadin-button on-click="_search">搜尋</vaadin-button>
    </div>
  <div id="slider-range"></div>
