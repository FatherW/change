...
import "./change-header-nav2.html";

class changeheader2 extends PolymerElement {
        ...
        <section class="top" style="height: 65px;">
            ...
            <section class="topWrap ">
                <div class="index-grid index-grid-md">
                    <div>
                        <a href="./getchange.html"><img
                                src="./Website%20Design/get%20tv/GET%20TV%20photo/logo/GetTV%20logo_0430-03.png"
                                class="logo"></a>
                    </div>
                    <div>
...
customElements.define('change-header2', changeheader2);