...
class dzElm extends PolymerElement {
    ...
    .index-grid {
      ...
      @media only screen and (max-width: 768px) {
                        ...
                        .mobileStatus change-user-panel {
                            position: absolute;
                            top: 0px;
                            right: 0px;
                        }

                        .full change-user-panel {
                            display: none;
                        }
    ...
    <div class="full">
        ...
        <div>
        <button class="paid" id="areachange" on-click="_areachange">買賣區</button>
    </div>
            <change-user-panel>
        ...
        <div></div>
        <img src="https://www.gettv.hk/img/add.png" on-click="_add"> <change-user-panel></change-user-panel></div>
    `;
    }
}
