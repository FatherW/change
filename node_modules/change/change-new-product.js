...
<div class="outer">
    <div class="change-new-product-container">
        <div class="left-pics">
            <!-- input pictures -->
            <div class="bigPic" id="div0" on-click="fancyBox"></div>
            <div>

                <!-- GG get Array Pic from Database -->
                <div class="consmall" on-click="_test">
                    <div>
                        <div id="div1"  on-click="fancyBox"></div>
                    </div>
                    <div>
                        <div id="div2" on-click="fancyBox"></div>
                    </div>
                    <div>
                        <div id="div3" on-click="fancyBox"></div>
                    </div>
                    <div>
                        <div id="div4" on-click="fancyBox"></div>
                    </div>
                </div>
            </div>
