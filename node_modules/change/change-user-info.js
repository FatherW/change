...
class dzElm extends PolymerElement {
  ...
  dataInit(){
    ...
    if (user) this.fileManager = new AwsPackage(user);
    Dazzle.uid = "change";
...
renew(){
    ...
    this.getMyAllStock(this.user['id']);
    // this.execute();
    console.log('My User',this.user);
    this.getMyPageList();
    this.myAll({
        target: this.shadowRoot.querySelector('#myAll')
    });
...
<div id="offer">
    ...
    <div id="buttonM">
        ...
        <template is="dom-if" if="{{own}}">
            ...
            <vaadin-button class="product-button" on-click="myStock">已下架貨品</vaadin-button>
            <vaadin-button class="product-button" id="myAll" on-click="myAll">我的所有貨品</vaadin-button>
