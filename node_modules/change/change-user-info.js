...
class dzElm extends PolymerElement {
  ...
  constructor() {
    ...
    this.userManager.searchDataByQuery(query).then(res=>{this.listPage = res;});
...
isOwn(){
    ...
    console.log('Is Own',Dazzle.subUser);
    if (!Dazzle.subUser)
        return false;
        
    console.log('Is Own',this.id,Dazzle.subUser['id']);
    
    if (this.id == Dazzle.subUser['id'] || Dazzle.subUser.isAdmin)
        return true;
    else
        return false;                
}
            ...
            <div id="left">
                <div id="info">
                    ...
                    <template is="dom-if" if="{{isOwn()}}">
                        ...
                        <vaadin-select id="area1" value$="{{user.area}}"></vaadin-select>-->
                    ...
                    <template is="dom-if" if="{{listPage.length}}">
                        <p class="inf">管理專頁:
                            <template is="dom-repeat" items="{{listPage}}">
                                <a href$="/page/{{item.alias}}">{{item.username}}</a>
                            </template>
