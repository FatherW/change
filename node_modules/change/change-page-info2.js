...
class dzElm extends PolymerElement {
    ...
    constructor() {
        ...
        if (user) {
            this.fileManager = new AwsPackage(Dazzle.subUser);
    ...
    ready() {
        ...
        this.userManager.loadData(this.id).then(res=>{
            ...
            // this.user['fansAdmin'].forEach(item=>{
            //     this.shadowRoot.querySelector('#myTags')._addTags(item);
            // });
            this.renew();
        },
        err=>{
    ...
    save(){
            ...
            this.user['fansAdmin'] = myTags.tags;
...
customElements.define('change-page-info2', dzElm);
