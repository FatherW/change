...
class changeheadernav extends PolymerElement {
    ...
    renew() {
        Dazzle.getContent('/json/category.json?id=' + new Date().getTime()).then(html => {
...
// Register the element with the browser.
>>>>>>> Stashed changes
customElements.define('change-header-nav', changeheadernav);