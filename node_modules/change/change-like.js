...
class dzElm extends PolymerElement {
  ...
  ready() {
      ...
      this.prodManager.getDataByCache(this.id).then(res=>{
        ...
        // try{
        //     this.product['like']=res['like'] || 0;
        // } catch(e){
        //     this.product['like']=0;
        // }
        // console.log('Like Product',this.product);
...
checkLike() {
    ...
    try{
        indexOf = user['likeProduct'].indexOf(id);
        // user['likeProduct'] = [...new Set(user['likeProduct'])];
    } catch(e){
        indexOf = -1;
//        user['likeProduct']=[];
    ...
    this.user = user;
    console.log('Like Product Array',user,user['likeProduct'],indexOf,id);
    ...
    // var counti2 = 0;
    // let checked2 = false;
    // // if (!Array.isArray(user['likeProduct']))
    // //     user['like']
    // // console.log("user liked", user);
    // for (let i = 0; i < countlikeproduct; i++) {
...
checklogin() {
    ...
    // let likeProduct = this.user['likeProduct'];
    // if (Array.isArray(likeProduct))  {
    //     if (likeProduct.indexOf(this.id)>-1)
    //         this.liked = true;
    //     else
    //         this.liked = false;
    // }
...
addCount() {
    ...
    let indexOf;
    try {
        indexOf = this.user['likeProduct'].indexOf(this.id);
    } catch(e){
        indexOf = -1;
        // this.user['likeProduct']=[];
    }

    if (shadow.querySelector('#toggle-heart').checked != true) {
        like--;
        this.product['like'] =like;
        if (indexOf>-1)
        ...
        this.product['like'] =like;
        if (indexOf == -1)
            this.user['likeProduct'].push(this.id);
