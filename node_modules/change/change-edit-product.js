...
import "../vaadin-text-field/vaadin-email-field.html";
import "../vaadin-text-field/vaadin-password-field.html";
import "../vaadin-checkbox/vaadin-checkbox.html";
import "../vaadin-text-field/vaadin-text-area.html";
import "../vaadin-text-field/vaadin-number-field.html";
import "../vaadin-select/vaadin-select.html";
import "../paper-tags-input/paper-tags-input.html";
import "../vaadin-button/vaadin-button.html";
import "../vaadin-dialog/vaadin-dialog.html";
import "../change/change-dropzone-file.html";

class editproductadmin extends PolymerElement {
    ...
    ready() {
        ...
        Dazzle.postData(Url, idparam).then(res => {
            if (res.code > 0) {
                if (res.resolve[0]['username']) {
    ...
    _saveData() {
        ...
        if (user != null) {
            ...
            Dazzle.postData(Url, p).then(res => {
                if (res.code > 0) {
        ...
        <div id="tbar">
            <div style="display: flex; margin-left: 25px;">
                ...
                <vaadin-checkbox-group label="Label" theme="vertical" id="secondlabel">
                    <vaadin-checkbox theme="custom" value="1" id="free">是否免費區</vaadin-checkbox>
                </vaadin-checkbox-group>
...
customElements.define('change-edit-product-admin', editproductadmin);