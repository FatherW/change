...
loadTags(tags) {
    ...
    if (tags) {
        if (tags.length == undefined || tags.length == null || tags.length == 0) {} else {
            shadow.querySelector('#description').innerHTML = "";
            // if (typeof tags === String) {
            //     tags = [tags];
            // }
            // console.log("ccc", tags);
            tags.forEach(item => {
                ...
                buttontag.addEventListener('click', e => {
                    ...
                    if (document.querySelector('change-itemspecial') || document.querySelector('change-user')) {
                        // alert("ccc")
                        location.assign("./list-product.html?tag=" + encodeURIComponent(item));
                    }
                })
...
customElements.define('change-item-tag', dzElm);
