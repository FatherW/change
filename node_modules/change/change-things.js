...
// import "/bower_components/dz-dazzle/css/medium-editor.js";
...
class changethings extends PolymerElement {
    ...
    ready() {
        ...
        this.dataManager.getDataByCache(this.id).then(res => {
            console.log('Things',res, res['productname'], res['id']);
            this.product = res;
        ...
        document.addEventListener('delete-item-' + this.id, e => {
            //            this._reallydelete();
            console.log('Delete This Item', this.id);
            this.dataManager.removeData(this.id);
            this.remove();
        });
    }
    async isShow() {
    ...
    static get template() {
        ...
        <style>
            ...
            #status {
                width: 15px;
                height: 15px;
                background-color: rgb(229, 182, 35);
                border-radius: 100%;
            }
