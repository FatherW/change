...
_submit() {
    ...
    this.userManager.getDataByCache(this.id).then(res=>{
            console.log('Rating User',res);
            let score = 0;
            try{
                score=res['score'].parseFloat();
            } catch(e){
                score =0;
            }
            if (!res['numberRate']) {
            ...
            console.log('Rating User',res['score'],this.userRate,res['numberRate']);
